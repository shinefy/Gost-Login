...
public class BrowserFactory {
	...
	public static WebDriver getIE() {
		...
		System.setProperty("webdriver.ie.driver", "E:\\pachong\\ghost-login\\ghost-login\\seleunim-driver\\chromedriver.exe"); // 必须加入
//		System.setProperty("webdriver.ie.driver", "E:\\pachong\\ghost-login\\ghost-login\\seleunim-driver\\ie\\IEDriverServer.exe"); // 必须加入
