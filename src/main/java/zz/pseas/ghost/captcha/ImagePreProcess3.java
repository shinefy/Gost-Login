...
public class ImagePreProcess3 {
	...
	public static Map<BufferedImage, String> loadTrainData() throws Exception {
		if (trainMap == null) {
			...
			File dir = new File("resources\\train3");
	...
	public static String getAllOcr(String file) throws Exception {
		...
		ImageIO.write(img, "JPG", new File("resources\\result3\\" + result + ".jpg"));
		return result;
	}
	...
	public static void downloadImage() {
		...
		for (int i = 0; i < 30; i++) {
			try {
				...
				// ��ȡ����
				String picName = "resources\\img3\\" + i + ".jpg";
	...
	public static void trainData() throws Exception {
		File dir = new File("resources\\temp3");
		File[] files = dir.listFiles();
		for (File file : files) {
			BufferedImage img = removeBackgroud("resources\\temp3\\" + file.getName());
			List<BufferedImage> listImg = splitImage(img);
			if (listImg.size() == 5) {
				for (int j = 0; j < listImg.size(); ++j) {
					ImageIO.write(listImg.get(j), "JPG", new File("resources\\train3\\"
	...
	public static void main(String[] args) throws Exception {
		...
		// downloadImage();
		for (int i = 0; i < 30; ++i) {
			String text = getAllOcr("resources\\img3\\" + i + ".jpg");
