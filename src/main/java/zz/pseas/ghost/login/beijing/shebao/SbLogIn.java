...
public class SbLogIn {
	public static void main(String[] args) {
		...
		String jduserNmae="15732612563";
		String jdpassWord="111111";
		...
		//map.put("username", jduserNmae);
		map.put("password", jdpassWord);
		/*map.put("return", "https://www.pconline.com.cn/");
		map.put("bindUrl", "https://my.pconline.com.cn/passport/editMobile.jsp?return=https://www.pconline.com.cn/");
		map.put("login_url", "https://my.pconline.com.cn/login.jsp");
		map.put("auto_login", "90");*/

		GhostClient client = new GhostClient("GBK", cookies);

		String url = "http://yzt.beijing.gov.cn/am/UI/Login";
